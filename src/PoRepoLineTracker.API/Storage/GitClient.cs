...
/// Consumed directly by <see cref="GitHubService"/> — the interface it used to sit behind
/// had one implementation, one injection site, and no test ever substituted it.
/// </summary>
